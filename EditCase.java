...
public class EditCase {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(int i=1;i<=rowCount;i++)
		{
			...
			if (caseNumber.equals("00001425"))
					{
				      System.out.println(i);
				      driver.findElement(By.xpath("//table[@data-aura-class='uiVirtualDataTable']//tr["+i+"]/td[7]")).click();
				      executor1.executeScript("arguments[0].click();", driver.findElement(By.xpath("//a[title='Edit']")));
				      break;
	    ...
	    driver.findElement(By.xpath("(//a[text()='--None--'])[5]")).click();
